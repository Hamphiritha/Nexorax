[ Application Link ](https://nexorax-oufvxvwc82cwkyfiabn4cj.streamlit.app/)
...
2. Open **PDF Analysis**
3. Upload an electric motor datasheet/catalogue PDF
4. Click **Analyze PDF**
5. Review extracted structured specifications and page-level evidence
6. Go to **Requirement Match** and choose **Uploaded PDF product**
7. Enter the user's requirement and click **Analyze Suitability**

The extractor is evidence-oriented: fields not found in the machine-readable PDF text are left empty rather than invented. For scanned/image-only PDFs, add OCR in a later version.

## Recommendations Catalog
Enter a natural-language motor requirement and TwinIQ ranks the best matching motors from the catalog. Each recommendation includes a compatibility score, verdict, passed checks, failed checks, missing data, and the structured product record used for the decision.
